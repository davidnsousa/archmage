...
`archmage.sh` will ask to (1) install yay (if not installed), (2) update the system, (3) choose from a preselection of packages to install and (4) costumize XFCE with a preselection of packages to install and a few tweaks.