...
Archmage installs the Pacman wrapper and AUR helper yay, updates the system, installs selected packages from the official Arch repositeries and AUR, and costumizes the desktop environment. Requires xfce4.
...
![https://imgur.com/ksXhv7V.png](https://imgur.com/ksXhv7V.png)